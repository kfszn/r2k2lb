            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                <Label htmlFor="player1-score">
                  {selectedMatch.player1?.kick_username || selectedMatch.player1?.roobet_username || selectedMatch.player1?.display_name || "Player 1"} Score
                </Label>
                <Input
                  id="player1-score"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="player2-score">
                  {selectedMatch.player2?.kick_username || selectedMatch.player2?.roobet_username || selectedMatch.player2?.display_name || "Player 2"} Score
                </Label>
                <Input
                  id="player2-score"
                  type="number"
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <PlayerBadge
            name={match.player1?.kick_username || match.player1?.roobet_username || match.player1?.display_name}
            score={match.player1_score}
            isWinner={match.winner_id === match.player1_id}
          />
          <span className="text-muted-foreground">vs</span>
          <PlayerBadge
            name={match.player2?.kick_username || match.player2?.roobet_username || match.player2?.display_name}
