...
export const metadata: Metadata = {
  title: 'Packdraw Leaderboard',
  description: 'Compete on the Packdraw leaderboard with code R2K2. Win monthly prizes for top players. Track your ranking, earn exclusive rewards, and climb the leaderboard.',
  ...
  openGraph: {
    title: 'Packdraw Leaderboard',
    description: 'Compete on the Packdraw leaderboard with code R2K2. Win monthly prizes for top players.',
