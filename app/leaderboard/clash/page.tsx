      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/assets/logo.png" alt="R2K2" width={40} height={40} className="rounded-lg" />
          ...
          <nav className="flex items-center gap-6">
            ...
            <Link href="/leaderboard/acebet" className="text-sm font-medium hover:text-primary transition-colors">
              Acebet
            </Link>
            <Link href="/leaderboard/packdraw" className="text-sm font-medium hover:text-primary transition-colors">
              Packdraw
            </Link>
