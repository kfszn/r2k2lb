...
export const metadata: Metadata = {
  title: 'Acebet Leaderboard | R2K2 - Win $5,000+ Monthly Rewards',
  description: 'Compete on the Acebet Leaderboard with code R2K2. $5,000+ in monthly prizes for top wagerers. Track rankings, earn rewards, and climb to the top. Join now!',
  ...
  openGraph: {
    title: 'Acebet Leaderboard | R2K2 - Win $5,000+ Monthly Rewards',
    description: 'Compete on the Acebet Leaderboard with code R2K2. $5,000+ in monthly prizes for top wagerers.',
