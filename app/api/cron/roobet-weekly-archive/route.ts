...
// Weekly Roobet leaderboard: rolling 7-day periods.
// PERIOD_ANCHOR is the start date (UTC) of period 1 — every subsequent
// period is an exact 7-day multiple offset from this anchor, so the cron
// can always compute "the period that just ended" without stored state.
const PERIOD_ANCHOR = "2026-08-03"; // first Monday of the current cycle
const PERIOD_DAYS = 7;
